...
export const HeroSlider = ({ hero }: IHeroData) => {
  const mainColor = hero.mainColor;
  const accentColor = hero.accentColor;
  const buttonColor = hero.buttonColor;
  return (
    <>
      <div className="pt-14 pl-5 laptop:pt-[175px] laptop:pl-[179px] flex flex-col relative">
        ...
        <div
          className={`font-azeret font-bold text-2xl laptop:text-[32px] text-[${mainColor}] mb-4 laptop:mb-6 w-full uppercase`}
        >
          {hero.title}
        </div>
        <div
