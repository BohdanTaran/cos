...
export const Footer = () => {
  return (
    <div className="flex flex-col bg-secondary-10 px-5 pt-10 pb-4">
      ...
      <Subscribe />
      <div className="mt-13">
        <div className="text-sm text-center font-normal text-text-tertiary items-center mt-12">
          Product specifications, prices, ship dates, and <br />
          availability are subject to change without notice.
        </div>
        <div className="text-sm text-center font-normal text-text-tertiary items-center mt-4">
          Privacy Policy | Terms & Conditions | Accessibility Statement
        </div>
        <div className="text-xs text-center font-normal text-text-tertiary items-center mt-12">
